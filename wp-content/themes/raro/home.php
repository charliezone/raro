...
<!-- Home -->
    ...
    <div class="container">
        ...
        <div class="row-base row">
            ...
            <div class="service-item">
                <img alt="" width="46" src="<?php echo get_template_directory_uri(); ?>/assets/img/img-icon/icon-architecture.png">
                <h4>Architecture</h4>
            </div>
            <div class="service-item">
                <img alt="" width="58" src="<?php echo get_template_directory_uri(); ?>/assets/img/img-icon/icon-interiors.png">
                <h4>Interiors</h4>
            </div>
            <div class="service-item">
                <img alt="" width="58" src="<?php echo get_template_directory_uri(); ?>/assets/img/img-icon/icon-planing.png">
                <h4>Planing</h4>
            </div>
            </div>
            <div class="clearfix visible-sm"></div>
            <div class="col-base col-about-img col-sm-6 col-md-4">
            <img alt="" class="img-responsive" src="<?php echo get_template_directory_uri(); ?>/assets/img/380x370.jpg">
            </div>
        </div>
        </div>
    </div>
    ...
    <div class="container">
        <div class="text-parallax" data-stellar-background-ratio="0.85" style="background-image: url('<?php echo get_template_directory_uri(); ?>/assets/img/bg/text-1.jpg');">
